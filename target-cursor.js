(function () {
  ...
  var AUTO_TARGETS =
    ".btn, .site-header__nav a, .site-header__brand, .site-header__toggle, .card, .for-you-card, .color-card, .service-card, .quiz-teaser__btn, .page-back a, .booking-modal__close, .service-modal__close";
